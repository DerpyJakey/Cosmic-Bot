...
public class DefaultConfig {
    ...
    public static void createDefaultChannelConfig(String channel) {
        ...
        String[] keys = {"Enable Bot", "Command Key", "Enable Blacklist", "Blacklist Rules", "Blacklist Response", "Enable Cap Limit", "Cap Limit Rules", "Cap Limit Response", "Enable Char Limit", "Char Limit Rules", "Char Limit Response", "Enable Word Limit", "Word Limit Rules", "Word Limit Response", "Enable Spam Protection", "Spam Protection Rules", "Spam Protection Response", "Timeout/Ban"};
        String[] values = {"False", "!", "False", "Bitch, Fuck", "You've said a blacklisted word!", "False", "10", "Too many caps!", "False", "100", "Too many text in a message!", "False", "50", "Too many words in a message!", "False", "10/5", "Too many messages in timeframe", "30s, 5m, 30m, 1h, ban"};
